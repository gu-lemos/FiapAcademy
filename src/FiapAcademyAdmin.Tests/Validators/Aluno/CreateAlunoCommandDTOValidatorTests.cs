...
{
    public class CreateAlunoCommandDTOValidatorTests
    {
        private readonly CreateAlunoCommandDTOValidator _validator;

        public CreateAlunoCommandDTOValidatorTests()
        {
            _validator = new CreateAlunoCommandDTOValidator();
        }

        [Fact]
        public void Validate_DeveSerValidoQuandoTodosOsCamposEstaoCorretos()
        {
            var dto = AlunoTestDataBuilder.CreateAlunoCommandDTO();
        ...
        [Fact]
        public void Validate_DeveSerInvalidoQuandoSenhaTemMenosDe8Caracteres()
        {
            var dto = AlunoTestDataBuilder.CreateAlunoCommandDTO();
            dto.Senha = "abc123!";
            var result = _validator.TestValidate(dto);
