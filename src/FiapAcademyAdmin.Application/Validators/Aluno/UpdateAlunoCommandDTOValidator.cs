...
{
    public class UpdateAlunoCommandDTOValidator : AbstractValidator<UpdateAlunoCommandDTO>
    {
        public UpdateAlunoCommandDTOValidator()
        {
            RuleFor(x => x.Id)
            ...
            RuleFor(x => x.Senha)
                .Must(ValidationHelpers.BeStrongPasswordWhenProvided).WithMessage("Senha deve conter letras maiúsculas, minúsculas, números e símbolos especiais");
        }
    }
} 